...
define('fb',['module', 'firebase', 'radio', 'util'],
        ...
        return {
            ...
            setupEvents: function () {
                ...
                this.el.addEventListener('click', function (e) {
                    ...
                    if (targetClasses.indexOf('show-settings') !== -1) {
                        radio.trigger('show_hide_settings');
                    }
                });
            },
...
define('modules/toDoList',['underscore', 'radio', 'fb', 'util', 'text!templates/toDoList.html'],
    function (_, radio, fb, util, toDoTpl) {
        return {
            ...
            setupEvents: function () {
                this.changeAuthHandler = this.changeAuth.bind(this);
                radio.on('auth/changed', this.changeAuthHandler);
                radio.on('value_changed', this.valueChanged.bind(this));
...
define('text!templates/settingsManager.html',[],function () { return '<% if (user) { %>\r\n    <input class="input image-picker" type="file" accept="image/jpeg,image/png">\r\n    <div class="level box images-container">\r\n    </div>\r\n<% } %>';});


define('text!templates/imageContainer.html',[],function () { return '<div class="level-item">\r\n    <figure class="image is-96x96 is-pulled-left image-preview"\r\n            data-id="<%= imageId %>"\r\n            data-path="<%= imagePath %>">\r\n        <img src="<%= imageSrc %>">\r\n        <span class="icon set-image">\r\n                <i class="fa fa-check-circle set-image"></i>\r\n        </span>\r\n        <a class="delete is-small delete-image"></a>\r\n    </figure>\r\n</div>';});

define ('modules/settingsManager',['fb', 'radio', 'underscore', 'text!templates/settingsManager.html', 'text!templates/imageContainer.html'], function(fb, radio, _, htmlStr, htmlStrImageContainer)
{
    return {
...
define('text!templates/errorDisplay.html',[],function () { return '<div class="notification <%= color %>">\r\n    <button class="delete"></button>\r\n    <%= message %>\r\n</div>';});

define ('modules/errorDisplay',['radio', 'underscore', 'text!templates/errorDisplay.html'], function(radio, _, htmlStr) {
...
define('app',['fb', 'radio', 'modules/menu', 'modules/toDoList', 'modules/settingsManager', 'modules/errorDisplay'],
