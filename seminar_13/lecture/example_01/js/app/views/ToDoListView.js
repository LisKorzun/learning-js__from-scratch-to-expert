define(['radio', 'underscore', 'text!templates/toDoListTemplate.html'],
    function (radio, _, toDoListTemplate) {
        ...
        ToDoListView.prototype = {
            ...
            show: function () {
                this.el.innerHTML = this.template({tasks: this.model.getTasks()});
            },
